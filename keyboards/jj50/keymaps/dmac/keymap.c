...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFLT] = LAYOUT( \
        ...
        KC_LSFT,            KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  MT(MOD_RSFT, KC_SLASH),  KC_ENT,\
        KC_LCTL,            KC_LGUI, KC_LALT, KC_LALT,KC_SPACE,MO(_RAISE),KC_SPC,KC_SPC,  KC_MINUS,KC_EQUAL,MO(_RAISE),                KC_DEL       \
    ),
