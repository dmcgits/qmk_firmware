...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFLT] = LAYOUT( \
        ...
        LT(_LOWER, KC_ESC), KC_A,       KC_S,    KC_D,    KC_F,    KC_G,        KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,    KC_ENTER,    \
        KC_LSFT,            KC_Z,   		KC_X,		 KC_C,    KC_V,    KC_B, 	      KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLASH, 	KC_RSFT,     \
        KC_LCTL,            KC_LCTL,    KC_LGUI, KC_LALT, KC_SPACE,KC_SPACE,  	MO(_RAISE),	MO(_RAISE), KC_RCTL,    KC_MINUS,   KC_EQUAL,  	KC_QUOT      \
    ),
    ...
    [_RAISE] = LAYOUT( \
       ...
       ______,    	KC_SYSTEM_SLEEP,  KC_LWIN,  KC_LCBR,  KC_RCBR,  ______,   ______,   KC_PGUP,  KC_UP,    KC_PGDN,    KC_PSCREEN,   RESET, \
       KC_CAPSLOCK, ______,   				______,  	KC_LPRN,  KC_RPRN,  ______,   KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RIGHT,   KC_END,       KC_QUOT, \
       ______,      KC_BSPACE,  			KC_DEL,  	KC_LBRC,  KC_RBRC,  RGB_TOG,  RGB_VAI,  	RGB_HUD,  RGB_HUI,  KC_VOLD,    KC_VOLU,      KC_QUES, \
    ...
    [_LOWER] = LAYOUT( \
        ...
        ______,  	KC_SYSTEM_SLEEP,  ______,   KC_LCBR,  KC_RCBR,  ______,					BL_ON,      BL_OFF,     BL_DEC,      BL_INC,    KC_PSCREEN, KC_BSLS,    \
        ______,   ______,    				______,   KC_LPRN,  KC_RPRN, 	KC_LABK,				KC_RABK,		KC_LABK,    KC_RABK,    KC_LBRC,    KC_RBRC,    KC_ENT,     \
        ______,   ______,   				______,   KC_LBRC,  KC_RBRC,  MDOWN_IMG_MACRO,______,			______,    	______,    RGB_SAD,    RGB_SAI,    	______,  \
        ______,  ______,    				______,   ______,   ______,   ______,      		______,      ______,    KC_MNXT,    KC_VOLD,    KC_VOLU,    ______    \
    ),
